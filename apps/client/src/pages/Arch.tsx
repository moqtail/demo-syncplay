...
import SyncPlayPipeline from "../assets/syncplay-pipeline.svg?react";
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-5xl overflow-x-auto z-10">
        <SyncPlayPipeline className="h-auto w-full min-w-[800px]" />
      </div>
      <div className="pointer-events-none absolute top-0 left-0 h-full w-full overflow-hidden">
        <div className="container mx-auto origin-top-left scale-125">
          <img
            src={MOQtail}
            alt="MOQtail"
            className="h-dvh -translate-x-32 -rotate-25 opacity-5 md:-translate-x-64"
          />
        </div>
      </div>
    </div>
